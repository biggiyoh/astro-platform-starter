...
const EVENTS = [
  {
    ...
    location: "Triq ta' Gianpula, Ħaż-Żebbuġ",
  ...
  },
  {
    ...
    tag: "Sunset Club",
    date: "Friday · 7pm – 2am",
    location: "Triq it-Trunciera, San Pawl il-BaĦar",
  ...
  },
  {
    ...
    date: "Every weekend",
    location: "Triq Ħal-GĦarġĦur, L-Iklin",
    spots: "Booking open",
  ...
  },
  {
    ...
    location: "Portomaso Tower, St. Julian's",
    spots: "Walk-ins welcome",
    description: "Rooftop bar and venue on the top floor of the iconic Portomaso Business Tower. Breathtaking 360° views of St. Julian's bay, craft cocktails, and an electric atmosphere high above Paceville.",
    color: "#C77DFF",
    lat: 35.9195,
    lng: 14.4937,
    bookingUrl: "https://juicyevent.fr",
